...
def print_banner(subtitle: str = "ClawGraph - Interactive Knowledge Graph"):
...
def print_section(title: str):
    ...
    console.print(f"[{border_color}]┌{'─' * 43}┐[/]")
    console.print(f"[{border_color}]│[/] [bold cyan]{title.ljust(41)}[/] [{border_color}]│[/]")
    console.print(f"[{border_color}]└{'─' * 43}┘[/]")
